...
import { CreditWallet, DebitWallet, GetUserTransaction } from '../../shared/action/wallet.action';
...
@Component({
    ...
    imports: [ReactiveFormsModule, PageWrapperComponent, Select2Module,
        NumberDirective, HasPermissionDirective, ButtonComponent,
        TableComponent, ConfirmationModalComponent, CommonModule, TranslateModule, CurrencySymbolPipe]
})
