...
import { NgbCalendar, NgbDate, NgbDateParserFormatter, NgbDateStruct, NgbNav, NgbNavItem, NgbNavItemRole, NgbNavLink, NgbNavLinkBase, NgbNavContent, NgbInputDatepicker, NgbAccordionDirective, NgbAccordionItem, NgbAccordionHeader, NgbAccordionToggle, NgbAccordionButton, NgbCollapse, NgbAccordionCollapse, NgbAccordionBody, NgbNavOutlet } from '@ng-bootstrap/ng-bootstrap';
import { Select2, Select2Data, Select2SearchEvent, Select2UpdateEvent, Select2Module } from 'ng-select2-component';
...
@Component({
    ...
    imports: [ReactiveFormsModule, NgbNav, NgbNavItem, NgbNavItemRole, NgbNavLink, NgbNavLinkBase, NgbNavContent, FormFieldsComponent, NgxEditorModule, Select2Module, NgbInputDatepicker, ButtonComponent, NgbAccordionDirective, NgbAccordionItem, NgbAccordionHeader, NgbAccordionToggle, NgbAccordionButton, NgbCollapse, NgbAccordionCollapse, NgbAccordionBody, ImageUploadComponent, AdvancedDropdownComponent, NgbNavOutlet, CommonModule, TranslateModule]
})
