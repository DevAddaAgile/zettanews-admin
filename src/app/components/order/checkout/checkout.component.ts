...
@Component({
    ...
    imports: [LoaderComponent, HasPermissionDirective, ReactiveFormsModule, Select2Module, AddressBlockComponent, DeliveryBlockComponent, PaymentBlockComponent, NoDataComponent, ButtonComponent, AddCustomerModalComponent, AddAddressModalComponent, CouponModalComponent, CommonModule, TranslateModule, CurrencySymbolPipe]
})
