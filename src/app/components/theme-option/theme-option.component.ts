...
@Component({
    ...
    imports: [PageWrapperComponent, ReactiveFormsModule, NgbNavModule, FormFieldsComponent, ImageUploadComponent, Select2Module, AdvancedDropdownComponent, NgxEditorModule, NgbNavOutlet, ButtonComponent, NgbAccordionModule, HasPermissionDirective, CommonModule, TranslateModule]
})
