...
@Component({
    ...
    imports: [ReactiveFormsModule, PageWrapperComponent, Select2Module, NumberDirective, HasPermissionDirective, ButtonComponent, TableComponent, ConfirmationModalComponent, CommonModule, TranslateModule]
})
