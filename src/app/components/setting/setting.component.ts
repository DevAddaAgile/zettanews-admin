...
@Component({
    ...
    imports: [PageWrapperComponent, ReactiveFormsModule, NgbNav, NgbNavItem, NgbNavItemRole, NgbNavLink, NgbNavLinkBase, NgbNavContent, FormFieldsComponent, ImageUploadComponent, Select2Module, ButtonComponent, NgbNavOutlet, HasPermissionDirective, CommonModule, TranslateModule]
})
