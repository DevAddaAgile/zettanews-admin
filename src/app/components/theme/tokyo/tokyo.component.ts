...
@Component({
    ...
    imports: [PageWrapperComponent, ReactiveFormsModule, NgbNavModule,
        FormFieldsComponent, ImageUploadComponent, LinkComponent, NgbNavOutlet, Select2Module, ButtonComponent,
        NgbAccordionModule, HasPermissionDirective, CommonModule, TranslateModule]
})
export class TokyoComponent {

  product$: Observable<Select2Data> = inject(Store).select(ProductState.products);
  home_page$: Observable<Tokyo> = inject(Store).select(ThemeState.homePage);
