...
import { Select2, Select2Data, Select2SearchEvent, Select2Module } from 'ng-select2-component';
...
import { NgbNav, NgbNavItem, NgbNavItemRole, NgbNavLink, NgbNavLinkBase, NgbNavContent, NgbNavOutlet, NgbAccordionDirective, NgbAccordionItem, NgbAccordionHeader, NgbAccordionToggle, NgbAccordionButton, NgbCollapse, NgbAccordionCollapse, NgbAccordionBody } from '@ng-bootstrap/ng-bootstrap';
...
export class DenverComponent {
  ...
  home_page$: Observable<Denver> = inject(Store).select(ThemeState.homePage);
