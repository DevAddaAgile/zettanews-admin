...
import { NgbAccordionModule, NgbNav, NgbNavContent, NgbNavItem, NgbNavItemRole, NgbNavLink, NgbNavLinkBase, NgbNavOutlet } from '@ng-bootstrap/ng-bootstrap';
...
import { Banners, Deal, Madrid, Offer } from '../../../shared/interface/theme.interface';
...
export class MadridComponent {
  ...
  home_page$: Observable<Madrid> = inject(Store).select(ThemeState.homePage);
