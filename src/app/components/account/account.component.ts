...
@Component({
    ...
    imports: [PageWrapperComponent, NgbNav, NgbNavItem, NgbNavItemRole, NgbNavLink, NgbNavLinkBase, NgbNavContent, ReactiveFormsModule, FormFieldsComponent, ImageUploadComponent, Select2Module, ButtonComponent, NgbNavOutlet, CommonModule, TranslateModule]
})
export class AccountComponent {
  ...
  constructor(private store: Store, private formBuilder: FormBuilder, @Inject(PLATFORM_ID) platformId: object) {
