import { Component, Inject, ViewChild, Input, Output, EventEmitter, Renderer2, inject } from '@angular/core';
...
import { DeleteModalComponent as DeleteModalComponent_1 } from '../modal/delete-modal/delete-modal.component';
...
@Component({
    ...
    imports: [ReactiveFormsModule, LoaderComponent, HasPermissionDirective, NgbDropdown, NgbDropdownToggle, NgbDropdownMenu, NgbDropdownItem, PaginationComponent, NoDataComponent, DeleteModalComponent_1, CommonModule, TranslateModule]
})
